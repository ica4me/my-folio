...
/* ----- TYPING EFFECT ----- 
 var typingEffect = new Typed(".typedText",{
    strings : ["Programmer","Networker","Freelancer"],
    loop : true,
    typeSpeed : 100, 
    backSpeed : 80,
    backDelay : 2000
 ...
 */
 document.addEventListener('DOMContentLoaded', function() {
  var myTitlesElement = document.getElementById('myTitles');
  var myTitles = JSON.parse(myTitlesElement.textContent);

  // Memastikan myTitles berisi data sebelum menggunakannya
